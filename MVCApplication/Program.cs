...
builder.Services.AddGatewayAuthClient<MVCApplication.Areas.Admin.Services.IVoucherAdminService, MVCApplication.Areas.Admin.Services.Implements.VoucherAdminService>(gatewayBase);
//setting authen
builder.Services
